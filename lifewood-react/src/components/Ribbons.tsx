/**
 * Ribbons – OGL-based animated ribbon strands that follow the cursor.
...
const Ribbons: FC<RibbonsProps> = ({
  ...
  useEffect(() => {
    ...
    mouseMoveHandler = updateMouse as EventListener;
    touchStartHandler = updateMouse as EventListener;
    touchMoveHandler = updateMouse as EventListener;
    ...
    update();
      ...
      console.error('[Ribbons] WebGL init failed:', err);
    }

/**
 * DecryptedText – Text scramble/decrypt animation on hover or scroll into view.
 * Adapted from ReactBits (MIT + Commons Clause). Converted to TypeScript.
 */
import { useEffect, useState, useRef, type FC, type CSSProperties } from 'react';
...
const DecryptedText: FC<DecryptedTextProps> = ({
  ...
  return (
    <span
      ...
      ref={containerRef}
      style={{ display: 'inline-block', whiteSpace: 'pre-wrap' as const }}
      {...hoverProps}
    >
